...
// It has a property called eat that is a function.
...
// #9  ###################
// # Prototype 2
// Write a constructor function called chimichanga.  It has a property called percentLeft = 100.
// It has a prototype function called eat.
...
function sentenceMachine(partOne) {
  return function sentenceSmasher(partTwo) {
    var newStr = partOne.concat(partTwo);
    return newStr;
  };
}
...
// When addIngredient is invoked it saves that ingredient with previously added ingredients and
// then returns an object that looks like this (Replace the parts wrapped in <> with correct data):
// ```
// {
